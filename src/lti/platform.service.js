...
var PlatformService = function () {
    ...
    var PlatformService = _classThis = /** @class */ (function () {
        function PlatformService_1() {
        }
        PlatformService_1.prototype.getOidcAuthUrl = function (issuer) {
            return __awaiter(this, void 0, void 0, function () {
                var base, discoveryUrl, res, doc, authUrl;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            base = issuer.replace(/\/$/, '');
                            discoveryUrl = "".concat(base, "/.well-known/openid-configuration");
                        ...
                        case 3:
                            if (res.status === 404) {
                                return [2 /*return*/, "".concat(base, "/api/lti/authorize_redirect")];
                            }
                            throw new Error("OIDC discovery failed: ".concat(res.status));
                    }
                });
            });
        };
