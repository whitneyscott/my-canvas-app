...
# Get all items in current directory, excluding node_modules, dist, and existing backups
$itemsToBackup = Get-ChildItem -Path . -Exclude "node_modules", "dist", "backup-*", ".git" | Where-Object {
