...
2. ~~Scanner assertion engine; respect **strict** vs **best_effort** gates.~~ — **done** for **pages + assignments** in manifest (strict OSS run **13/13**).
