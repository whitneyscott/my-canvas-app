...
2. ~~Scanner assertion engine; respect **strict** vs **best_effort** gates.~~ — **done** for **pages + assignments** in manifest (strict OSS run **17/17** violation rows).
